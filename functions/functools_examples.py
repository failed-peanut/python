...
print("Sum of list with initiator 10 {}".format(reduce(lambda a,b:a+b,list_,10)))
#O/P:25 providing 10 as initiator so 1st element will be added with 10 then so on...
...
print('6 > 2 :', N(6)>N(2)) #O/P:6 > 2 : False
print('3 < 1 :', N(3)<N(1)) #O/P:3 < 1 : True
print('2 <= 7 :', N(2)<= N(7)) #O/P:2 <= 7 : False
print('9 >= 10 :', N(9)>= N(10)) #O/P:9 >= 10 : True
print('5 == 5 :', N(5)== N(5)) #O/P:5 == 5 : True
...
'''
add_par=add_one(5)
print(f"Using partial funtion : {add_par}")#O/P:Using partial funtion : 8
# value of a: 100 and value of b:30
print(f"Using partial funtion : {add_one_again(100)}")#Using partial funtion : 130
...
def decorator(f): 
    ...
    print('Documentation of decorated :', decorated.__doc__) #O/P:Documentation of decorated : f's Docstring
    return decorated 
...
print('f name :', f.__name__) #O/P:f name : f
print('Documentation of f :', f.__doc__) #O/P:Documentation of f : f's Docstring
########################################################################################################################
...
@fun.register(list)
def _(obj):
    obj.append("object")#O/P:[1, 2, 3, 4, 5, 'object']
    print(obj)
